...
public class CharacterEncoding {
	...
	private static void printEncodingDetails(String symbol) {
		System.out.println("\nSymbol: " + symbol);
		try {
			// Below are different encoding schemes.
			System.out.println("ASCII: " + Arrays.toString(symbol.getBytes("US-ASCII"))); //ASCII - American standard
			...
			System.out.println("UTF-16 BE: " + Arrays.toString(symbol.getBytes("UTF-16BE"))); // Big Endianess
			System.out.println("UTF-16 LE: " + Arrays.toString(symbol.getBytes("UTF-16LE"))); // low Endianess
