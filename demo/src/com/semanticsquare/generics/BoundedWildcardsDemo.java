...
public class BoundedWildcardsDemo <T> {
	...
	static void boundedWildcards() {		
		...
		/* Check display method implementation to demo wildcard bound usage*/
		List<Integer> intList = Arrays.asList(11,21,31);
		display(intList);
		List<Double> doubleList = Arrays.asList(11.5,21.5,31.5);
		display(doubleList);
		
		/* Check aggregateWithConsumer method implementation to demo wildcard bound usage*/
		...
		/* This is to show how Java utils use wildcard ounds in addAll and copy*/
