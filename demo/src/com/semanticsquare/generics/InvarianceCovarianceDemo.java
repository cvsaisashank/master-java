 ...
 * A) Knowing and enforcing type constraint at runtime. Arrays are reified as they enforce the type checking at run time but not 
 *    at compile time.
 * Q) What is `non-reified` mean?
 * A) `non-reified` are generics as they enforce type checking at compile time.
 * */
