 ...
 * 6. If first bound is a class then remaining must be interfaces. In other words we also cannot have other classes in the list of bounds.
 * 7. for final Classes and enums, the type argument will is bound itself.
 * */
