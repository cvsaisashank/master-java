...
public class UnboundWildcard{
	...
	public static void main(String[] args) {
		...
		/* Below method is an example using unbound wild card while above method getCommonElementsCount is an example using raw type*/
		...
		Object object = someStore.get(); // As the Container1 is of some type which we don't know, we can only assign it to an Object
		System.out.println("Stored element: " + object); // Output: Java	
		
		/* Below method invalidAggregate demoes on what type of methods we cannot call when using unbound wildcard type argument.*/
